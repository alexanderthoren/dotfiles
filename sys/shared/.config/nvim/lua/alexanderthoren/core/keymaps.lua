...
keymap.set("n", "<leader><C-h>", "<C-w>H", { desc = "Swap to window at the left" })
keymap.set("n", "<leader><C-J>", "<C-w>J", { desc = "Swap to the window below" })
keymap.set("n", "<leader><C-K>", "<C-w>K", { desc = "Swap to the window above" })
keymap.set("n", "<leader><C-L>", "<C-w>L", { desc = "Swap to the window at the right" })
